...
import { GridPostsList, Loader, PostStats } from "@/components/shared/routes";
        ...
        <div className="post_details-card">
          ...
          <div className="post_details-info">
            <div className="flex-between w-full">
              ...
              >
                <img
                  src={post?.creator.imageUrl || ProfileIcon}
                  alt="creator"
              ...
              <div className="flex-center gap-4">
                ...
                >
                  <img src={EditPostIcon} alt="edit" width={24} height={24} />
                </Link>
